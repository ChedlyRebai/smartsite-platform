...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite site management service. You help users manage construction sites, equipment, and resources.';
