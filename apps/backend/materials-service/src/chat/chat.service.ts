...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite materials service. You help users manage construction materials, inventory, QR codes, and stock levels.';
