...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite notification service. You help users manage alerts, notifications, and communication across the platform.';
