...
export class AiChatService implements OnModuleInit {
  ...
  private readonly systemPrompt =
    'You are a helpful assistant for the SmartSite platform. You help users manage construction projects, teams, users, roles, permissions, suppliers, materials, planning, incidents, payments, and site management. Answer clearly and concisely.';
  ...
  onModuleInit() {
    ...
    if (!apiKey) {
      ...
      this.logger.log(`✅ Groq AI Chat initialized — model: ${model} — key: ${apiKey.substring(0, 10)}...`);
    }
  }
