...
export class ChatbotController {
  ...
  async sendMessage(@Req() req: any, @Body() dto: SendMessageDto) {
    ...
    console.log(
      `**********************************************************************Processing quick command: ${userId} with role: ${userRole}`,
    );
  ...
  async processQuickCommand(
    ...
    console.log(
      `Processing quick command: ${command} with language: ${language} for user: ${userId} with role: ${userRole}`,
    );
  ...
  async permanentlyDeleteConversation(
    ...
    const userId = req.user?.userId || req.user?.id || req.user?._id;
    return this.chatbotService.permanentlyDeleteConversation(
      userId,
      conversationId,
    );
  }
  ...
  async getArchivedConversations(
    ...
    const userId = req.user?.userId || req.user?.id || req.user?._id;
    return this.chatbotService.getArchivedConversations(
      userId,
