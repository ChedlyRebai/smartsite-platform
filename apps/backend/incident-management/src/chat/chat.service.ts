...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite incident management service. You help users report, track, and resolve construction site incidents and safety issues.';
