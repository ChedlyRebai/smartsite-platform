...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite planning service. You help users manage tasks, milestones, and project stages.';
