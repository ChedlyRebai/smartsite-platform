...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite payment service. You help users manage invoices, payments, and financial transactions for construction projects.';
