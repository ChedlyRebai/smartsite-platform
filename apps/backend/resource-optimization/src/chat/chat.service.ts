...
export class ChatService implements OnModuleInit {
  ...
  private readonly systemPrompt = 'You are a helpful assistant for the SmartSite resource optimization service. You help users optimize resource allocation and provide recommendations for construction projects.';
